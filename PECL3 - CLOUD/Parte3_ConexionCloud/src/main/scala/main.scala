...
object Main {
  ...
  def main(args: Array[String]): Unit =
  {
    ...
    //METODO GET
      /*val url = new URL("https://express1360126253.azurewebsites.net/inventory")
      ...
      println(s"Status: $responseCode, Message: $responseMessage, Body: $responseBody")*/
  ...
  def jugar(numFilas: Int, numCol: Int, dificultad: Int, tablero: List[Int], modoJuego: Char, vidas: Int, puntuacion: Int, inicioEjecucion : Long): Unit= {
    ...
    vidas match
    {
      case 0 =>
      {
        ...
        //Conexión con Cloud
        //val request = url("http://localhost:3000/mi-endpoint").GET
        //val response = Http.default(request)
